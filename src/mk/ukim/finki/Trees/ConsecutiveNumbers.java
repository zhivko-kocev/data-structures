...
//    }
//
//    public void preorderR(BNode<E> n,List<E> list) {
//        if (n != null) {
//            list.add(n.info);
//            preorderR(n.left,list);
//            preorderR(n.right,list);
//        }
//    }
//
...
//        AtomicReference<Integer> pred= new AtomicReference<>(list.get(0));
//        return list.stream().skip(1).allMatch(element->{
//         boolean answer= element-pred.get() ==2;
//         pred.set(element);
//         return answer;
//        });
//    }
